...
#include "lib.h"
#define KiB4 4096
#define VID_MEM_BYTES 80 * 25 * 2 // dimensions of video memory
...
// Sturcutre for page directory entires
...
extern void swap_terminal_mapping(int new_terminal);
extern void user_mapping(void);
